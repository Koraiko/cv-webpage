...
const Main: React.FC = () => {
    ...
    const pageComponents: JSX.Element[] = [<Intro pathToJson="/content/aboutMe.json" />, /*<AnimationExamples />,*/ <CvOverview />, <CvTimeline />, <ContactMe />, <Inspiration />];
    ...
    return (
        <div id="main-container" style={
            {
                backgroundColor: settings["color-styles"]["background-primary"] || '#ffffff',
                color: settings["color-styles"]["text-primary"] || '#000000'
            }
        }>
            <div className='w-100 position-fixed p-2'
                id="WIP-alert"
            ...
            >
                <div className="alert alert-warning w-100 text-center" role="alert">
                    <strong>Under Construction!</strong><br /> This page is currently being developed. Some information may <u>not be complete</u> and features may <u>not work as expected</u>.
                </div>
            </div>
