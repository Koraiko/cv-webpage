...
const ScrollInOut: React.FC<ScrollInOutProps> = ({
     ...
     */
    const getAnimationState = (phase: 'initial' | 'final') => {
        return ANIMATION_STATES[phase][direction as keyof typeof ANIMATION_STATES.initial] || 
    ...
    const findScrollContainer = (element: HTMLElement) => {
        return element.closest('.scroll-box') || 
     ...
     */
    const createTimeline = (elements: Element[] | HTMLElement[]) => {
        ...
        const staggerValue = stagger > 0 ? (animateLeftToRight ? stagger : -stagger) : 0;
        ...
        .to(elements, {
            ...
            ease: 'power2.in',
            stagger: stagger > 0 ? (animateLeftToRight ? stagger * 0.3 : -(stagger * 0.3)) : 0,
        });
    ...
    }, [direction, duration, delay, ease, triggerStart, triggerEnd, animateOut, stagger, animateLeftToRight]);
