...
import {
  ...
  ChromeOriginal, PrologOriginal, NodejsOriginalWordmark, BootstrapOriginal,
  MatlabOriginal,
  CplusplusOriginal,
  HaskellOriginal
} from 'devicons-react';
...
const skillItems: SectionInfo[] = [
  ...
  },
  {
    ...
    'content': [{
      ...
      name: 'NoSQL',
      icon: <><span className="m-s-filled fs-1">database </span><span className="m-s-filled fs-1">data_object</span></>
    }, {
      name: 'Node.js',
...
const CvOverview: React.FC = () => {
  ...
  const cardDesign = "d-flex justify-content-center align-items-center rounded p-2";
  return (
    <div id="TechStackComponent" className={`w-100 d-flex my-4 py-4`}>

      <style>{flipStyles}</style>

        <ScrollInOut direction="scale" ease="back.out(2)" duration={3} stagger={0.2} className="d-flex flex-row justify-content-around w-100">
