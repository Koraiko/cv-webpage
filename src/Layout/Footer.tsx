    ...
    const filterAvailableItems = () => {
      const availableItems = allItems.filter(item => {
        return pages.some(page => {
          const componentName =
            typeof page.type === 'string' ? page.type : page.type.name;
  ...
  return (
    <>
      ...
      <div className={'position-sticky bottom-0 d-none d-sm-flex m-0'}>
        <footer
          className={'w-100 m-0 px-0 d-flex flex-column'}
          style={{
            height: footerHeight,
            zIndex: 1000,
        ...
        >
          ...
          />
          <div
            className="w-100 d-flex justify-content-around align-items-center flex-nowrap m-0"
